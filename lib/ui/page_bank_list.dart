...
import 'package:standardappstructure/model/bank.dart';
import 'package:standardappstructure/ui/bank_item_page.dart';
import 'package:standardappstructure/utils/theme.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromRGBO(140, 128, 255, 1.0),
      ),
